...
if word[0] > 'Z':
    word_sum = sum(letter for i in word for letter, point in ru_alphabet.items() if i in point)
    print(word_sum)
else:
    word_sum = sum(letter for i in word for letter, point in eng_alphabet.items() if i in point)
    print(word_sum)
